...
namespace EnrollmentSystem
{
    public partial class editsection : Form
    {
        ...
        {
            DialogResult result = MessageBox.Show("Do you want to remove the student '"+ idtxt.Text+ " from " + sectiontxt.Text + "'?\nThis action cannot be undone. ", "Remove Student?", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
